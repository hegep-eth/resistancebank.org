...
observeEvent(input$add_amr_test, {
  ...
  # Animal sample origin
  if (!is.null(eval(parse(text = paste0("input$sample_origin_", input_number() - 1))))) {

    sample_origin_value = eval(parse(text = paste0("input$sample_origin_", input_number() - 1)))
  ...
  # Quality control
  if (!is.null(eval(parse(text = paste0("input$quality_control_", input_number() - 1))))) {

    quality_control_value = eval(parse(text = paste0("input$quality_control_", input_number() - 1)))

  } else {

    quality_control_value = ""

  }

  # Method
  if (!is.null(eval(parse(text = paste0("input$antimicrobial_use_", input_number() - 1))))) {

    antimicrobial_use_value = eval(parse(text = paste0("input$antimicrobial_use_", input_number() - 1)))

  } else {

    antimicrobial_use_value = ""
                  ...
                  tags$table(style = "width: 100%;
                             ...
                             tags$tr(tags$td(style = "width: 7.14%;",
                                     ...
                                     tags$td(style = "width: 7.14%;",
                                             align = "center",
                                             selectizeInput(inputId = paste0("sample_origin_",
                                                                             input_number()),
                                                            label = NULL,
                                                            choices = list("Meat" = "",
                                     ...
                                     tags$td(style = "width: 7.14%;",
                                             align = "center",
                                             selectizeInput(inputId = paste0("quality_control_",
                                                                             input_number()),
                                                            label = NULL,
                                                            choices = c("ATCC 25922" = "",
                                                                        "None",
                                                                        quality_controls$type_strain_control),
                                                            selected = quality_control_value,
                                                            width = "95%",
                                                            multiple = FALSE,
                                                            options = list(create = FALSE))
                                     ),
                                     tags$td(style = "width: 7.14%;",
                                             align = "center",
                                             selectizeInput(inputId = paste0("antimicrobial_use_",
                                                                             input_number()),
                                                            label = NULL,
                                                            choices = list("Yes" = "",
                                                                           "Yes",
                                                                           "No"),
                                                            selected = antimicrobial_use_value,
                                                            width = "95%",
                                                            multiple = FALSE,
                                                            options = list(create = FALSE))
                                     ),
...
response_amr <- reactive({
  ...
  if (input_number() != 0) {
    ...
    response_amr <- data.frame("Species" = sapply(X = 1:input_number(),
                               ...
                               "SampleOrigin" = sapply(X = 1:input_number(),
                                                       FUN = function(i) {

                                                         input[[paste0("sample_origin_", i)]]
                               ...
                               "QualityControl" = sapply(X = 1:input_number(),
                                                         FUN = function(i) {

                                                           if (input[[paste0("quality_control_", i)]] == "") {

                                                             return(NA)

                                                           } else {

                                                             input[[paste0("quality_control_", i)]]

                                                           }

                                                         }),
                               "AntimicrobialUseReported" = sapply(X = 1:input_number(),
                                                                   FUN = function(i) {

                                                                     input[[paste0("antimicrobial_use_", i)]]
